...
export default class IconSvg extends React.Component<IIconProps> {
    ...
    exitIcon(color: string) {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="14px" height="14px" viewBox="0 0 1280.000000 1280.000000" preserveAspectRatio="xMidYMid meet">
    ...
    public render() {
        ...
        return (
            <IconWrapper>
                {this.exitIcon(color ? color : '#61dafb')}
            </IconWrapper>
        );
    }
}
